...
// link history from local browser history
useEffect(()=>{
...
const handleSubmit = async(e)=>{
  ...
  if (data?.summary){
    ...
    // ... -> to spreed all articles ,i.e to add the new articles at the end of existing ones (to append)   
      ...
      {allArticles.map((item,index) =>(
        <div
         ...
         <div className='copy_btn' onClick={()=> handleCopy(item.url)}>
          <img src={ copied === item.url ? tick : copy } //change the copy icon if copied
            alt="copy_icon"
